...
const OrderCard = ({order, updateOrder}) => {
    ...
    return (
        <View>
                {
                    order.status === OrderStatuses.REJECTED || order.status === OrderStatuses.FINISHED ? null
                        :
                        (
                        <View>
                            {order.status === OrderStatuses.EXPANDED ?
                                <View style={styles.rectangle}>
                                    ...
                                    <View style={styles.right_side}>
                                        ...
                                        <OrderActionButton order={order} accept={false} updateOrder={updateOrder}/>
                                    </View>
                                </View>
                                :
                                <View style={styles.rectangle}>
