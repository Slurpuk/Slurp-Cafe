...
describe('Sign Up Two Page', function () {
    ...
    describe('Pressing Sign Up => form field tests', function () {
        it('should raise alert on submit with empty shop page name', async function () {
            const {getByText} = render(<SignUpContext.Provider value={signUpContextMock}>
                <SignUpPageTwo />
        ...
        it('should raise alert on less than 20 character description', async function () {
            ...
            const description=getByPlaceholderText('150 characters describing the qualities of your coffee shop');
        ...
        it('should raise alert on more than 150 character description', async function () {
            ...
            const description=getByPlaceholderText('150 characters describing the qualities of your coffee shop');
            expect(description).toBeTruthy();
            fireEvent.changeText(description, 'kqbvlekrbvlbvhbkbwkqejvdvhjbjlhbvjhdsbjhbsjdvbhljhbhhhhhhhhhhhhhhhhhhhhhaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaahhhhhhhhhhhhhhhddddddddddddddddddddddddddddddddddddddddddddddddd');
